...
class FacialLandmarksDetectionModel:
    ...
    def predict(self, image):
        ...
        left_eye_xmin = coords[0]-20
        left_eye_ymin = coords[1]-20
        left_eye_xmax = coords[0]+20
        left_eye_ymax = coords[1]+20
        
        right_eye_xmin = coords[2]-20
        right_eye_ymin = coords[3]-20
        right_eye_xmax = coords[2]+20
        right_eye_ymax = coords[3]+20
